...
AudioCapture::AudioCapture(uint16_t capture_type, uint32_t sample_rate, uint16_t channel_config,
...
void AudioCapture::setAudioCaptureCallback(void (*callback)(int8_t *data, uint32_t len, void *ctx),
                                           void *ctx) {
    if (_record_impl)
