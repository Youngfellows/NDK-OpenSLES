package com.speex.audiorecord.tester;

import android.content.Context;
import android.os.Environment;
import android.util.Log;

import com.speex.audiorecord.api.audio.AudioPlayer;
import com.speex.audiorecord.api.wav.WavFileReader;
...
public class AudioPlayerTester extends Tester {
    ...
    public AudioPlayerTester(File file) {
        DEFAULT_TEST_FILE = file.getAbsolutePath();
        Log.i(TAG, "AudioPlayerTester:: DEFAULT_TEST_FILE=" + DEFAULT_TEST_FILE);
    }
